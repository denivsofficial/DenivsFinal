    ...
    <div className='w-full bg-slate-50'>
      ...
      <div className='relative z-20 -mt-16 md:-mt-24 px-4 md:px-10 max-w-5xl mx-auto'>
        <div className='bg-white/90 backdrop-blur-md p-4 md:p-6 rounded-2xl shadow-xl border border-white/40'>
          ...
          <form onSubmit={(e) => e.preventDefault()} className='flex flex-col sm:flex-row shadow-md rounded-xl overflow-hidden border border-gray-200 bg-white'>
            <input
              type='text'
            ...
            <button
              type='submit'
              className='bg-blue-950 hover:bg-blue-800 transition text-white px-6 md:px-10 py-3 md:py-4 text-sm md:text-base font-semibold whitespace-nowrap w-full sm:w-auto'
            >
              Search
            </button>
          </form>

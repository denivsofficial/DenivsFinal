...
const PostPropertyBanner = () => {
  ...
  return (
    <section className="relative w-full max-w-7xl mx-auto my-12 overflow-hidden bg-white rounded-3xl shadow-sm min-h-60 aspect-video md:h-[450px] md:aspect-auto">
      ...
      <div className="absolute inset-0 z-10 flex items-end justify-center p-4 sm:p-6 md:items-center md:justify-end md:p-16 lg:p-24">
        <button 
          onClick={() => navigate('/post-property')}
          className="inline-flex items-center justify-center gap-2.5 px-6 py-3 rounded-xl bg-[#001A33] text-white font-bold text-base md:gap-3 md:px-8 md:py-3.5 md:text-lg tracking-wide shadow-xl hover:bg-[#13304c] transition-all duration-300 transform hover:-translate-y-1 active:scale-95 group focus:ring-4 focus:ring-blue-900/40"
        >

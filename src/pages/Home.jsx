...
const Home = () => {
  return (
    /* Changed pb-20 to pb-0 because the Footer handles bottom padding */
    <div className='w-full bg-slate-50 min-h-screen'>
      
      {/* ── Hero Section ── */}
      {/* Changed aspect-ratio to better support scrolling flow */}
      ...
      <div className='relative z-20 -mt-24 px-4 md:px-10 max-w-5xl mx-auto'>
        <div className='bg-white/90 backdrop-blur-md p-4 md:p-6 rounded-2xl shadow-xl border border-white/40'>
          ...
          {/* Category Filters */}
          <div className='flex justify-between items-center mt-6 overflow-x-auto no-scrollbar gap-4'>
            <div className='flex flex-col items-center gap-2 group cursor-pointer min-w-[80px]'>
              <div className='p-3 bg-blue-50 rounded-xl group-hover:bg-blue-100 transition shadow-sm'>
                <HomeIcon className='w-6 h-6 text-blue-950' />
              </div>
              <span className='text-xs font-semibold text-slate-600 group-hover:text-blue-950'>Residential</span>
            </div>
      ...
      {/* ── 3. FEATURED LISTING SECTION (NEW) ── */}
      {/* We add py-12 to ensure it has space below the search bar */}

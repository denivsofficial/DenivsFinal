...
const Navbar = () => {
    ...
    return (
        <nav className='bg-white z-10 backdrop-blur-md shadow-sm fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-3 border-b border-gray-100'>
            {/* 1. Logo Section */}
                    ...
                    <>
                        ...
                        <div className='flex items-center gap-4 pl-4 border-l border-gray-200'>
                            <div className="flex items-center gap-2">
                                {/* If user has an avatar from Google Auth, show it. Otherwise show icon */}
                                {user?.avatar ? (
